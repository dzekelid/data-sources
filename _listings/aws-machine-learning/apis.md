...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/data-sources/master/_listings/aws-machine-learning/apis.md
...
- name: AWS Machine Learning API - Create Data Source From R D S
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data-sources/master/_listings/aws-machine-learning/actioncreatedatasourcefromrds-get-openapi.md
- name: AWS Machine Learning API - Create Data Source From Redshift
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data-sources/master/_listings/aws-machine-learning/actioncreatedatasourcefromredshift-get-openapi.md
- name: AWS Machine Learning API - Create Data Source From S3
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data-sources/master/_listings/aws-machine-learning/actioncreatedatasourcefroms3-get-openapi.md
- name: AWS Machine Learning API - Delete Data Source
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data-sources/master/_listings/aws-machine-learning/actiondeletedatasource-get-openapi.md
- name: AWS Machine Learning API - Describe Data Sources
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data-sources/master/_listings/aws-machine-learning/actiondescribedatasources-get-openapi.md
- name: AWS Machine Learning API - Get Data Source
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data-sources/master/_listings/aws-machine-learning/actiongetdatasource-get-openapi.md
- name: AWS Machine Learning API - Update Data Source
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/data-sources/master/_listings/aws-machine-learning/actionupdatedatasource-get-openapi.md
- name: AWS Machine Learning API - Create Data Source From R D S
  x-api-slug: actioncreatedatasourcefromrds-get
  description: Creates a DataSource object from an.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Analytics_AmazonMachineLearning.png
